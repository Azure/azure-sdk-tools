...
This document provides a comprehensive list of all MCP (Model Context Protocol) tools and commands supported by the Azure SDK MCP server version 0.6.33.
...
| azsdk_apireview_get_approval_status | `azsdk api-review get-approval-status` | Check API review release approval status using APIView and API Review Hub. |
