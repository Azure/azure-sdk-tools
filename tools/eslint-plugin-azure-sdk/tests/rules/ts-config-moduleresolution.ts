/**
 * @fileoverview Testing the ts-config-moduleResolution rule.
 * @author Arpan Laha
 */

import rule from "../../src/rules/ts-config-moduleresolution";
...
ruleTester.run("ts-config-moduleresolution", rule, {
  valid: [
    {
  ...
  invalid: [
    ...
    },
    {
      ...
      code: '{"outer": {"compilerOptions": { "moduleResolution": "node" }}}',
      filename: "tsconfig.json",
      errors: [
        {
          message: "compilerOptions does not exist at the outermost level"
    ...
    {
      // commpilerOptions does not contain moduleResolution
      code: '{"compilerOptions": { "module": "node" }}',
      filename: "tsconfig.json",
      errors: [
        {
          message: "moduleResolution is not a member of compilerOptions"
        }
      ]
    },
    {
