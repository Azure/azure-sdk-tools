...
func scenarioMicrosoftSignalrserviceBasicCrud(t *testing.T) {
	...
	proximityPlacementGroupsClient := golang.NewProximityPlacementGroupsClient(con,
		subscriptionId)
	{
	...
	virtualMachinesClient := golang.NewVirtualMachinesClient(con,
		subscriptionId)
	{
