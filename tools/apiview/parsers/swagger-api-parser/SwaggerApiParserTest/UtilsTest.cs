...
public class UtilsTest
{
    ...
    public void SerializePatterenedObjectsCreatesTokensFromDiffPropertyTypes()
    {
        ...
        dynamic xMSEnum = new ExpandoObject();
        xMSEnum.name = "name";
        xMSEnum.modelAsString = true;

        dynamic externDoc = new ExpandoObject();
        externDoc.description = "description";
        externDoc.url = "url";
        externDoc.patternedObjects = new Dictionary<string, dynamic>();
        externDoc.patternedObjects.Add("x-ms-long-running-operation", true);
        ...
        response.header = new Dictionary<string, dynamic>();
        response.header.Add("header", header);

        Dictionary<string, Dictionary<string, dynamic>> xmSPaths = new Dictionary<string, Dictionary<string, dynamic>>();
        dynamic opt = new ExpandoObject();
        opt.description = "description";
        opt.summary = "summary";
        opt.externalDocs = externDoc;
        opt.operationId = "operationId";
        opt.consumes = new List<dynamic>() { "application/json" };
        opt.produces = new List<dynamic>() { "application/json" };
        opt.parameters = new List<dynamic>() { parameter };
        opt.responses = new Dictionary<string, dynamic>();
        opt.responses.Add("200", response);
        ...
        patterenedObjects.Add("x-ms-nullable", true);
        patterenedObjects.Add("x-ms-enum", xMSEnum);
        patterenedObjects.Add("x-ms-discriminator-value", "disc");
