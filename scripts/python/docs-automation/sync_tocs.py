...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            "Execution requires that both the known namespaces and reference yml be defined. Error message: " + str(f)
        )

    present_in_target = grep_children_namespaces(target_autogenerated_toc)
    present_in_target = sorted(list(dict.fromkeys(present_in_target)))
    print(
