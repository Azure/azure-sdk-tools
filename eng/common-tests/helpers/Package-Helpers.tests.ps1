...
Describe "Get-FullPackageName" {
    BeforeAll {
        . $PSScriptRoot/../../common/scripts/Helpers/Package-Helpers.ps1
    }

    It "Should return Name when Group is not present" {
        $packageInfo = [PSCustomObject]@{
            Name = "azure-core"
            ArtifactName = "azure-core"
        }

        $result = Get-FullPackageName -PackageInfo $packageInfo
        $result | Should -Be "azure-core"
    }

    It "Should return Name when Group is empty" {
        $packageInfo = [PSCustomObject]@{
            Name = "azure-core"
            ArtifactName = "azure-core"
            Group = ""
    ...
    It "Should return Name when Group is null" {
        $packageInfo = [PSCustomObject]@{
            Name = "azure-core"
            ArtifactName = "azure-core"
            Group = $null
    ...
    It "Should return Group+ArtifactName format when Group exists" {
        $packageInfo = [PSCustomObject]@{
            Name = "com.azure:azure-core"
            ArtifactName = "azure-core"
            Group = "com.azure"
        }

        $result = Get-FullPackageName -PackageInfo $packageInfo
        $result | Should -Be "com.azure+azure-core"
    }

    It "Should return Group:ArtifactName format when UseColonSeparator is enabled" {
        $packageInfo = [PSCustomObject]@{
            Name = "com.azure:azure-core"
            ArtifactName = "azure-core"
            Group = "com.azure"
        ...
        $result = Get-FullPackageName -PackageInfo $packageInfo -UseColonSeparator
        $result | Should -Be "com.azure:azure-core"
    }

    It "Should return Name when UseColonSeparator is enabled but Group is empty" {
        $packageInfo = [PSCustomObject]@{
            Name = "azure-core"
            ArtifactName = "azure-core"
            Group = ""
