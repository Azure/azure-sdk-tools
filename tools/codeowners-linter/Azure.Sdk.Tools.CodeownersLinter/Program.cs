    ...
    internal class Program
    {
                                      ...
                                      bool   generateBaseline)
        {
            ...
            if (filterBaselineErrors)
            {
                ...
                {
                    throw new ArgumentException($"The CODEOWNERS baseline error file, {codeownersBaselineFile}, file for {repoName} does not exist. Should this be running in this repository?");
                }
            }
