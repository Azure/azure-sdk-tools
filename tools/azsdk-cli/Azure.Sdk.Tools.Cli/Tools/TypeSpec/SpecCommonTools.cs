...
namespace Azure.Sdk.Tools.Cli.Tools.TypeSpec
{
    ...
    public class SpecCommonTools(IGitHelper gitHelper, ILogger<SpecCommonTools> logger) : MCPTool
    {
        ...
        {
            var command = new Command(getModifiedProjectsCommandName, "Get list of modified TypeSpec projects");
            command.Options.Add(repoRootOpt);
            command.Options.Add(targetBranchOpt);
            return command;
        }
