...
| async-return-async-iterable               | Check that client async methods don't return sync iterables (ItemPaged).                                                                                                        | # pylint:disable=async-return-async-iterable                                      | [link](https://github.com/Azure/azure-sdk-for-python/issues/26681)
