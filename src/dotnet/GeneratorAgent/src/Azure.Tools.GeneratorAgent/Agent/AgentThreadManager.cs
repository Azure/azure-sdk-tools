...
{
    internal class AgentThreadManager
    {
        private readonly PersistentAgentsClient Client;
        private readonly ILogger<AgentThreadManager> Logger;
        private readonly AppSettings AppSettings;

        public AgentThreadManager(PersistentAgentsClient client, ILogger<AgentThreadManager> logger, AppSettings appSettings)
        {
