...
2. **Gather Missing Info** — Collect only missing details. See [details](https://github.com/Azure/azure-sdk-tools/blob/main/plugins/azure-sdk-tools/skills/prepare-release-plan/references/release-plan-details.md):
