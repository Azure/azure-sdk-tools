...
namespace Azure.Sdk.Tools.PerfAutomation
{
    public interface ILanguage
    {
        ...
        Task<IterationResult> RunAsync(string project, string languageVersion, string primaryPackage, IDictionary<string, string> packageVersions, string testName, string arguments, object context, bool profiling);
