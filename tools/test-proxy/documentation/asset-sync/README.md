...
Use [the transition script](../../../../eng/common/testproxy/transition-scripts/generate-assets-json.ps1) and follow the [readme](../../../../eng/common/testproxy/transition-scripts/README.md)!
