...
public class PlanConfiguration
{
    ...
    private static readonly Regex schemaPattern = new (@"https\://raw\.githubusercontent\.com/azure/azure-sdk-tools/(?<branch>.+?)/schemas/secret-rotation/(?<version>.+?)/schema\.json", RegexOptions.IgnoreCase);
