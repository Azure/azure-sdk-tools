...
| [azsdk-common-apiview-api-content-retrieval](azsdk-common-apiview-api-content-retrieval/SKILL.md) | "show me the API surface", "get API content", "give me the CodeFile" | Retrieve API surface content from APIView |
