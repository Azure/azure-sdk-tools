...
namespace APIViewWeb.Managers
{
    public interface ICommentsManager
    {
        ...
        public Task<IEnumerable<CommentItemModel>> GetCommentsAsync(string reviewId, bool isDeleted = false, CommentType? commentType = null, bool excludeDiagnostics = false);
        ...
        public Task ResolveConversation(ClaimsPrincipal user, string reviewId, string lineId, string threadId = null);
        public Task<List<CommentItemModel>> CommentsBatchOperationAsync(ClaimsPrincipal user, string reviewId, BatchConversationRequest request);
        ...
        public Task AddCommentFeedbackAsync(ClaimsPrincipal user, string reviewId, string commentId, CommentFeedbackRequest feedback, bool queueCopilotNotification = true);
