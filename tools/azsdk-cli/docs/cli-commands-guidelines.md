...
- `tsp client customized-update --package-path <absolute-package-path> --edit-scope CustomCode --customization-request "Repair the custom-code build failures" --max-attempts 3`
