...
namespace Azure.Sdk.Tools.Cli.Tools.TypeSpec
{
    ...
    ) : MCPTool
    {
        ...
        {
            var command = new Command(ConvertSwaggerCommandName, "Convert an existing Azure service swagger definition to a TypeSpec project");
            command.Options.Add(swaggerReadmeArg);
            command.Options.Add(outputDirectoryArg);
            command.Options.Add(isArmOption);
            command.Options.Add(fullyCompatibleOption);
            return command;
        }
