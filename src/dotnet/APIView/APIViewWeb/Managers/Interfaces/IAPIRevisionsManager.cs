...
namespace APIViewWeb.Managers.Interfaces
{
    public interface IAPIRevisionsManager
    {
        ...
        public Task UpdateAPIRevisionCopilotDetailsAsync(APIRevisionListItemModel revision, bool copilotReviewInProgress, string copilotReviewJobId = null, bool? hasAutoGeneratedComments = null);
