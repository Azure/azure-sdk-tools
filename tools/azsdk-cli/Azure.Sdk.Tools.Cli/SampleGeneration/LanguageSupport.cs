...
- The sample class should inherit from SamplesBase<T> where T is the appropriate TestEnvironment class, e.g. SamplesBase<<Name of the Client>TestEnvironment>
...
- Filenames must be descriptive without file extension (e.g., ""create_key_example"", ""retrieve_keys_example"")
- Use proper Python naming conventions: snake_case for functions and variables, PascalCase for classes
- Include appropriate import statements
- Use async/await for asynchronous operations with asyncio
- Include proper exception handling with try-except blocks
- Use DefaultAzureCredential for authentication examples
- Follow PEP 8 style guidelines
- Include docstrings for functions and classes
- Use type hints where appropriate
- Return structured JSON in this format: [{""fileName"": ""example_name"", ""content"": ""# Python code here""}]",
