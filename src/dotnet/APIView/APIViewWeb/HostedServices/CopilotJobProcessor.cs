    ...
    public class CopilotJobProcessor : ICopilotJobProcessor
    {
        ...
        public async Task ProcessJobAsync(AIReviewJobInfoModel jobInfo, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                bool hasAutoGeneratedComments = string.Equals(result.Status, "Success", StringComparison.OrdinalIgnoreCase);
                ...
                await _apiRevisionsManager.UpdateAPIRevisionCopilotDetailsAsync(jobInfo.APIRevision, copilotReviewInProgress: false, hasAutoGeneratedComments: hasAutoGeneratedComments);
            ...
            {
                await _apiRevisionsManager.UpdateAPIRevisionCopilotDetailsAsync(jobInfo.APIRevision, copilotReviewInProgress: false);
