...
) : MCPTool
{
    ...
    protected override Command GetCommand()
    {
        ...
        command.Arguments.Add(requiredArg);
        command.Options.Add(optionalParam);
...
) : MCPMultiCommandTool
{
    ...
    {
        var analyzeCommand = new Command(SubCommandName1, "Analyze something");
        analyzeCommand.Options.Add(fooOption);

        var processCommand = new Command(SubCommandName2, "Process something");
        processCommand.Options.Add(fooOption);
        processCommand.Options.Add(barOption);

        return [analyzeCommand, processCommand];
    }
