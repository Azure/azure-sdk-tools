...
public class LanguageServicePackageInfoTests
{
    ...
    public void Setup()
    {
        ...
        languageServices = [
            new DotnetLanguageService(processHelper, Mock.Of<IPowershellHelper>(), Mock.Of<ICopilotAgentRunner>(), gitHelper.Object, new TestLogger<DotnetLanguageService>(), Mock.Of<ICommonValidationHelpers>(), packageInfoHelper, Mock.Of<IFileHelper>(), Mock.Of<ISpecGenSdkConfigHelper>(), Mock.Of<IChangelogHelper>(), Mock.Of<ICiYamlHelper>()),
