...
| client-async-list-methods-return-async-iterable               | Check that client async methods don't return sync iterables (ItemPaged).                                                                                                        | # pylint:disable=client-async-list-methods-return-async-iterable                                     | [link](https://github.com/Azure/azure-sdk-for-python/issues/26681)
