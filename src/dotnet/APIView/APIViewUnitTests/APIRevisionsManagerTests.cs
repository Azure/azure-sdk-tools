...
public class APIRevisionsManagerTests
{
    ...
    #region CopyApprovalFromAsync Tests

    [Fact]
    public async Task CopyApprovalFromAsync_CopiesApprovalStatus()
    {
        ...
        await _manager.CopyApprovalFromAsync(targetRevision, sourceRevision);
