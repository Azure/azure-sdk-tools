...
- `infra/main.bicepparam` maps the environment-suite exports into
  `main.bicep` for every environment.
...
- [ ] `azd provision --preview` shows expected delta only
...
| [infra/main.bicepparam](infra/main.bicepparam)                                                   | Shared azd-to-Bicep parameter adapter                          |
