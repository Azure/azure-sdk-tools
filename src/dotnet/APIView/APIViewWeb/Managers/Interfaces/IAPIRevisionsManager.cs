...
namespace APIViewWeb.Managers.Interfaces
{
    public interface IAPIRevisionsManager
    {
        ...
        public Task<(bool updateReview, APIRevisionListItemModel apiRevision)> CopyApprovalFromAsync(APIRevisionListItemModel targetRevision, APIRevisionListItemModel sourceRevision);
