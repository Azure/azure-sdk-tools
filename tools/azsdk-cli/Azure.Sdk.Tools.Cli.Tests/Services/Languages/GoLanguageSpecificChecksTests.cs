...
namespace Azure.Sdk.Tools.Cli.Tests.Services
{
    internal class GoLanguageSpecificChecksTests
    {
        ...
        public async Task TestGoLanguageSpecificChecksBasic()
        {
            ...
            var resp = await LangService.AnalyzeDependenciesAsync(GoPackageDir, CancellationToken.None, false);
            Assert.That(resp.ExitCode, Is.EqualTo(0));
            ...
            resp = await LangService.FormatCodeAsync(GoPackageDir, CancellationToken.None, false);
            ...
            resp = await LangService.LintCodeAsync(GoPackageDir, CancellationToken.None, false);
            Assert.That(resp.ExitCode, Is.EqualTo(0));
        }
        ...
        public async Task TestGoLanguageSpecificChecksLintErrors()
        {
            ...
            var resp = await LangService.LintCodeAsync(GoPackageDir, CancellationToken.None, false);
            Assert.Multiple(() =>
            {
                Assert.That(resp.ExitCode, Is.EqualTo(1));
