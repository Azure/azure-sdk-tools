...
var nestedValue = require("../utils/structure");
...
module.exports = {
  ...
  create: function(context) {
    var checkers = nestedValue(context, {
    ...
    return {
      ...
      "VariableDeclarator > ObjectExpression": checkers.outerCheck,

      // check that strict is a member of compilerOptions
      "Property[key.value='compilerOptions']": checkers.innerOuterCheck,
