...
namespace Azure.Sdk.Tools.TestProxy.Matchers
{
    ...
    public class CustomDefaultMatcher : RecordMatcher
    {
        ...
        /// /// <param name="nonDefaultIgnoredHeaders">A comma separated list of additional headers that should be ignored during matching.</param>
        ...
        public CustomDefaultMatcher(bool compareBodies = true, string nonDefaultHeaderExclusions = "", string nonDefaultIgnoredHeaders = "", bool ignoreQueryOrdering = false) : base(compareBodies: compareBodies, ignoreQueryOrdering: ignoreQueryOrdering)
        {
            ...
            foreach (var exclusion in nonDefaultIgnoredHeaders.Split(",").Where(x => !string.IsNullOrEmpty(x.Trim())))
            {
