...
7. Review and approve each of your **Sync PRs** and resolve any open review conversations. For some repos (C and C++) you might need to frequently use the `Update Branch` button to get the checks green.
    - You can mass approve and mark AI-generated PR reviews as resolved with [this script](https://github.com/Azure/azure-sdk-tools/blob/main/eng/scripts/Approve-Sync-PRs.ps1): `<repo root>/eng/scripts/Approve-Sync-PRs.ps1 -engCommonSyncPRNumber <tools sync PR>`
