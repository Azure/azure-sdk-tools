...
namespace Azure.Sdk.Tools.Cli.Tests.Tools
{
    ...
    public class CodeownersToolsTests
    {
        ...
        public async Task Update_InvalidInputs_Throws()
        {
            ...
            var result = await _tool.UpdateCodeowners("repo", "", "", "", new List<string>(), new List<string>(), false);
        ...
        public async Task Update_LabelMissing_NotInReview_NoPath_Throws()
        {
            ...
            var tool = new CodeownersTools(gh.Object, _mockOutput.Object, _mockTypeSpecHelper.Object, _codeownersHelper, _mockCodeownersValidator.Object);

            var result = await tool.UpdateCodeowners("repo", "", "", "NonExistService", new List<string>(), new List<string>(), true);
        ...
        public async Task Update_CreateNewEntry_PRSuccess()
        {
            ...
            var tool = new CodeownersTools(gh.Object, _mockOutput.Object, typespec.Object, new CodeownersHelper(), validator.Object);

            var result = await tool.UpdateCodeowners("repoName", "", "/sdk/newsvc/", "NewSvc", new List<string> { "@a", "@b" }, new List<string> { "@s1", "@s2" }, true);
            Assert.IsNotNull(result);
        ...
        public async Task Validate_CODEOWNERS_Missing_ReturnsError()
        {
            ...
            var tool = new CodeownersTools(gh.Object, output.Object, typespec.Object, helper, validator.Object);
