...
namespace APIViewWeb.Controllers
{
    ...
    public class CommentsController: Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Add(string reviewId, string revisionId, string elementId, string commentText, string sectionClass, string groupNo, bool sampleComment = false, string sampleId = null, string resolutionLock = "off")
        {
            ...
            comment.IsSampleComment = sampleComment;
            comment.SampleId = sampleId;
