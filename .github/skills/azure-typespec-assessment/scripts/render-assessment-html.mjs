...
<section id="downstream-breaking"><h2>Downstream breaking changes <span class="count">${downstreamFindings.length}</span></h2>${renderFindingCategory(downstreamFindings, "No downstream breaking changes detected.")}</section>
