...
namespace ApiView
{
    public readonly struct CodeLine: IEquatable<CodeLine>
    {
        ...
        public CodeLine(string html, string id, string lineClass, int? lineNumber = null, int? sectionKey = null, int indent = 0)
        {
        ...
        public CodeLine(CodeLine codeLine, string html = null, string id = null, string lineClass = null, int? lineNumber = null, int? sectionKey = null, int indent = 0)
        {
