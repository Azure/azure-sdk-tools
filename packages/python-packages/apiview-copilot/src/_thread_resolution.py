...
def handle_thread_resolution_request(
    *, comments: list[str], language: str, package_name: str, code: str, source_thread_id: str = None
    ...
    if action == "record_result":
        ...
        results = _execute_plan(plan=plan, is_exception=False, package_name=package_name, source_thread_id=source_thread_id)
        ...
        results = _execute_plan(plan=plan, is_exception=True, package_name=package_name, source_thread_id=source_thread_id)
        return _summarize_results(results)
...
def _execute_plan(*, plan: dict, is_exception: bool, package_name: str, source_thread_id: str = None):
    """
    ...
    if source_thread_id:
        raw_memory["source_thread_id"] = source_thread_id
