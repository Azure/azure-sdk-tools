...
export const dockerCliInput = convict<DockerCliInput>({
    ...
    sdkWorkBranchLink: {
        ...
        arg: 'sdk-work-branch',
        format: String,
        doc: `The link of sdk work branch generated by pipeline, which will be used in grow up scenario if you want docker container help you clone the sdk work branch.`
    }
});
