...
namespace APIViewWeb
{
    public class JsonLanguageService : LanguageService
    {
        ...
        public override async Task<CodeFile> GetCodeFileAsync(string originalName, Stream stream, bool runAnalysis, string croscrossLanguageMetadatasLanguagePackageMetadata = null)
        {
