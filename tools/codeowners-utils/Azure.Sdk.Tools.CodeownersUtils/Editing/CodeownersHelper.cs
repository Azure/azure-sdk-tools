...
{
<<<<<<<< HEAD:tools/codeowners-utils/Azure.Sdk.Tools.CodeownersUtils/Editing/CodeownersHelper.cs
...
>>>>>>>> 941336658ac91ea6f93e079916d9b83981e3cee2:tools/codeowners-utils/Azure.Sdk.Tools.CodeownersUtils/Editing/CodeownersEditor.cs
        {
            string normalizedPath = path;
            if (!string.IsNullOrWhiteSpace(path))
            {
