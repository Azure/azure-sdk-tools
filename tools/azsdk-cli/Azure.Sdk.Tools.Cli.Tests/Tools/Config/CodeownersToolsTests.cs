...
namespace Azure.Sdk.Tools.Cli.Tests.Tools.Config
{
    ...
    public class CodeownersToolsTests
    {
        ...
        public async Task Update_LabelMissing_NotInReview_NoPath_Throws()
        {
            ...
            var tool = new CodeownersTool(gh.Object, new TestLogger<CodeownersTool>(), null, _mockCodeownersValidator.Object, _mockcodeownersGenerateHelper.Object);
        ...
        public async Task Update_AddOwnersToExistingEntry_Success()
        {
            ...
            var tool = new CodeownersTool(gh.Object, new TestLogger<CodeownersTool>(), null, validator.Object, _mockcodeownersGenerateHelper.Object);
        ...
        public async Task Validate_CODEOWNERS_Missing_ReturnsError()
        {
            ...
            var tool = new CodeownersTool(gh.Object, new TestLogger<CodeownersTool>(), null, validator.Object, generateHelper.Object);
