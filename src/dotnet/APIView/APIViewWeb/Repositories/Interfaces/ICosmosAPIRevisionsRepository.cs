...
namespace APIViewWeb.Repositories
{
    public interface ICosmosAPIRevisionsRepository
    {
        ...
        /// <summary>
        /// Partially updates Copilot-related metadata for an API revision without replacing the full document.
        /// </summary>
        /// <param name="reviewId">The review partition key.</param>
        /// <param name="apiRevisionId">The revision identifier.</param>
        /// <param name="copilotReviewInProgress">Whether Copilot review is currently in progress.</param>
        /// <param name="copilotReviewJobId">Optional Copilot job identifier to set.</param>
        /// <param name="hasAutoGeneratedComments">Optional flag indicating whether auto-generated comments exist.</param>
        /// <returns></returns>
        public Task UpdateAPIRevisionCopilotDetailsAsync(string reviewId, string apiRevisionId, bool copilotReviewInProgress, string copilotReviewJobId = null, bool? hasAutoGeneratedComments = null);
