...
public interface INamespaceManager
{
    ...
    Task<NamespaceOperationResult> UpdateNamespaceStatusAsync(string projectId, string languageKey, NamespaceDecisionStatus newStatus, string notes, ClaimsPrincipal user);
