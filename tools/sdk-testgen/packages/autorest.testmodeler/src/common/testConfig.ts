...
export class TestConfig {
    constructor(public readonly config: Record<string, any>, public readonly defaultValues: Object) {}

    public getValue(path: string, d: any = undefined) {
        if (d === undefined) return _.get(this.config, path, this.defaultValues[path]);
        else return _.get(this.config, path, d);
    }
