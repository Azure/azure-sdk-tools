...
namespace APIViewWeb
{
    public abstract class LanguageProcessor : LanguageService
    {
        ...
        public override async Task<CodeFile> GetCodeFileAsync(string originalName, Stream stream, bool runAnalysis)
        {
            ...
            return await RunParserProcess(originalName, tempDirectory, jsonFilePath, Name);
        }
        ...
        public async Task<CodeFile> RunParserProcess(string originalName, string tempDirectory, string jsonPath, string language)
        {
            try
            {
                ...
                _telemetryClient.TrackEvent($"Completed {language} process run to parse " + originalName);
