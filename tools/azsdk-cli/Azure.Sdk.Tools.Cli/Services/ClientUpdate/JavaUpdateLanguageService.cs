...
public class JavaUpdateLanguageService : ClientUpdateLanguageServiceBase
{
    ...
    private readonly Azure.Sdk.Tools.Cli.Microagents.IMicroagentHostService _microagentHost;
    ...
    public JavaUpdateLanguageService(
        ...
        Azure.Sdk.Tools.Cli.Microagents.IMicroagentHostService microagentHost) : base(languageSpecificCheckResolver)
    {
        _logger = logger;
