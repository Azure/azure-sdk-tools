...
namespace APIViewWeb.Managers.Interfaces
{
    ...
    {
        public Task<CodeFileResult> GetCodeFileAsync(string repoName, string buildId, string artifactName, string packageName, string originalFileName, string codeFileName,
            MemoryStream originalFileStream, string baselineCodeFileName = "", MemoryStream baselineStream = null, string project = "public", string language = null, string metadataFileName = null);
