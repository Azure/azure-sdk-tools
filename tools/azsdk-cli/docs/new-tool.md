...
- **Base Class**: If the purpose of the tool is to run an operation at package or language level then tool must be inherited from [`LanguageMcpTool`](../Azure.Sdk.Tools.Cli/Tools/Core/LanguageMcpTool.cs) or [`LanguageMultiCommandTool`](../Azure.Sdk.Tools.Cli/Tools/Core/LanguageMultiCommandTool.cs). Otherwise all tools must inherit from [`MCPTool`](../Azure.Sdk.Tools.Cli/Tools/Core/MCPTool.cs) or [`MCPMultiCommandTool`](../Azure.Sdk.Tools.Cli/Tools/Core/MCPMultiCommandTool.cs).
