...
{
    /// <summary>
    /// A language service for OpenAPI 2.0 specifications in JSON.
    /// </summary>
    public class SwaggerLanguageService : LanguageService
    {
        ...
        internal class SwaggerTree
        {
            ...
            public SwaggerTree Add(string name, string navigationId)
            {
