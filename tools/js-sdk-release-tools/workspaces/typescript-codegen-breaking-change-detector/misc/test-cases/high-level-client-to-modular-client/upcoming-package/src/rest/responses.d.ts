...
/** Azure operation completed successfully. */
export interface DataProductsCatalogsListByResourceGroup200Response extends HttpResponse {
    status: "200";
    body: DataProductsCatalogListResultOutput;
}
export interface DataProductsCatalogsListByResourceGroupDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
export interface DataProductsCatalogsListBySubscription200Response extends HttpResponse {
    status: "200";
    body: DataProductsCatalogListResultOutput;
}
export interface DataProductsCatalogsListBySubscriptionDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
...
/** Azure operation completed successfully. */
export interface DataTypesGenerateStorageContainerSasToken200Response extends HttpResponse {
    status: "200";
    body: ContainerSasTokenOutput;
}
export interface DataTypesGenerateStorageContainerSasTokenDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
...
export interface DataTypesListByDataProductDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
...
/** Azure operation completed successfully. */
export interface DataProductsGenerateStorageAccountSasToken200Response extends HttpResponse {
    status: "200";
    body: AccountSasTokenOutput;
}
export interface DataProductsGenerateStorageAccountSasTokenDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Action completed successfully. */
...
export interface DataProductsRemoveUserRoleDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
export interface DataProductsListRolesAssignments200Response extends HttpResponse {
    status: "200";
    body: ListRoleAssignmentsOutput;
}
export interface DataProductsListRolesAssignmentsDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
export interface DataProductsListByResourceGroup200Response extends HttpResponse {
    status: "200";
    body: DataProductListResultOutput;
}
export interface DataProductsListByResourceGroupDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
/** Azure operation completed successfully. */
export interface DataProductsListBySubscription200Response extends HttpResponse {
    status: "200";
    body: DataProductListResultOutput;
}
export interface DataProductsListBySubscriptionDefaultResponse extends HttpResponse {
    status: string;
    body: ErrorResponseOutput;
}
