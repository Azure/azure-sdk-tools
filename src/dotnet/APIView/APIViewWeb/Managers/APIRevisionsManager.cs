...
namespace APIViewWeb.Managers
{
    public class APIRevisionsManager : IAPIRevisionsManager
    {
        ...
        /// This copies properties that should be preserved across revisions
        /// with identical API surfaces, regardless of approval status.
        /// </summary>
        ...
        {
            if (targetRevision == null || sourceRevision == null)
            {
                return;
            }
            ...
            if (sourceRevision.HasAutoGeneratedComments && !targetRevision.HasAutoGeneratedComments)
            {
