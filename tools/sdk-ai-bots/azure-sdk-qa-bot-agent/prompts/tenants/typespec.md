...
- Preserve compatible operations and aliases already supplied by the user. Verify and reuse an existing polling/status operation instead of inventing a replacement, and include the exact namespace or alias required for every recommended standard construct rather than assuming unseen setup.
