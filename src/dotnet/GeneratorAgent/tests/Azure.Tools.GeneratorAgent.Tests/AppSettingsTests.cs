...
namespace Azure.Tools.GeneratorAgent.Tests.Configuration
{
    ...
    public class AppSettingsTests
    {
        ...
        [Test]
        public void ProjectEndpoint_WithNullValue_ThrowsException()
        {
            var configurationMock = CreateConfigurationMock();
            ...
            Assert.Throws<InvalidOperationException>(() => _ = appSettings.ProjectEndpoint);
        }

        [Test]
        public void ProjectEndpoint_WithEmptyValue_ThrowsException()
        {
            var configurationMock = CreateConfigurationMock();
