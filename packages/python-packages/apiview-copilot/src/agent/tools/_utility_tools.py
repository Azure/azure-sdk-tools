...
class UtilityTools(Tool):
    ...
    def summarize_api(self, api: str, language: str):
        ...
        return call_foundry_model(
            prompt_file=get_prompt_path(folder="summarize", filename="summarize_api"),
            inputs={"content": api, "language": language},
        )
    ...
    def summarize_api_diff(self, target: str, base: str, language: str):
        ...
        return call_foundry_model(
            prompt_file=get_prompt_path(folder="summarize", filename="summarize_diff"),
            inputs={"content": api_diff, "language": language},
        )
