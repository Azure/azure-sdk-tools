...
namespace APIViewWeb
{
    public abstract class LanguageService
    {
        ...
        public virtual string ReviewGenerationPipelineId { get; } = String.Empty;
        public virtual CodeFile GetReviewGenPendingCodeFile(string fileName) 
        {
            ...
            var line3 = $"See {ReviewGenerationPipelineId}";
            ...
            if (UsesTreeStyleParser)
            {
                ...
                if (!string.IsNullOrEmpty(ReviewGenerationPipelineId))
                {
