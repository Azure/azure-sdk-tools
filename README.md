...
| agentic-workflow               | [Readme](tools/agentic-workflow/README.md)              | Drives a research → plan → implement workflow for AI coding agents, one fresh Copilot SDK session per phase. | Not Yet Enabled |
