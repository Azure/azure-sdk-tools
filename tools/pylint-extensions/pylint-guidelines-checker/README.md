...
| exception-logging                 |  Do not log exceptions unless it is a debug statement.                                                                                                           | # pylint:disable=exception-logging                                     | No guideline, just helps to protect against logging personally identifiable information.                    |