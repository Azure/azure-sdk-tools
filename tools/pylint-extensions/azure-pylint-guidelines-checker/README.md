...
docstring-type-formatted-incorrectly | pylint:disable=docstring-type-formatted-incorrectly    |      Docstring type is formatted incorrectly. Please following Sphinx formatting.               | [link](https://sphinx-rtd-tutorial.readthedocs.io/en/latest/docstrings.html)           |
