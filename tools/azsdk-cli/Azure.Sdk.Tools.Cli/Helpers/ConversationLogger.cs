...
";
            await File.WriteAllTextAsync(logPath, logContent, ct);
        }
        catch (Exception ex)
        {
...
";
            ...
            await File.AppendAllTextAsync(logPath, turnContent, ct);
        }
        catch (Exception ex)
        {
...
";
            ...
            // Write to workspace log file
            await File.AppendAllTextAsync(logPath, toolContent, ct);
        }
        catch (Exception ex)
        {
...
";
            await File.AppendAllTextAsync(logPath, endContent, ct);
        }
        catch (Exception ex)
        {
