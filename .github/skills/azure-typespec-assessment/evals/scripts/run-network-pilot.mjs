...
function prepareAgentWorkItem(
  ...
  const workItem = {
    ...
    instructions: [
      ...
      "For documentQualityReviewUnits, resolve canonical @doc/documentation-comment and declaration evidence and write exactly one documentQualityDecisions entry with check: description per ready document: Does the @doc description clearly and accurately explain the associated TypeSpec code? Do not use external or generated documentation.",
