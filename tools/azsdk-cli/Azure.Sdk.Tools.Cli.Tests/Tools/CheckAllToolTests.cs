...
namespace Azure.Sdk.Tools.Cli.Tests.Tools
{
    ...
    public class CheckAllToolTests
    {
        ...
        public async Task ChangelogValidationFixTool_WithValidPath_ReturnsFailureResult()
        {
            ...
            {
                Assert.IsTrue(failureResult.Error.Contains("No CHANGELOG.md file found in package at:"));
            }
            else
            {
                Assert.IsTrue(result.Output.Contains("No CHANGELOG.md file found in package at:"));
            }
        }
