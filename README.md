...
| perf-regression-finder         | [Readme](tools/perf-regression-finder/README.md)         | An AI Agent for for diagnosing and solving performance regressions in Azure SDKs using Semantic Kernel and Azure AI Agents.       | Not Yet Enabled                                                                                                                                                                                                                            |
