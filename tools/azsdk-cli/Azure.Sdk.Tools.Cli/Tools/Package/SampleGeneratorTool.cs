    ...
    public class SampleGeneratorTool : MCPTool
    {
        ...
        public override async Task HandleCommand(InvocationContext ctx, CancellationToken ct)
        {
            ...
            try
            {
                ...
                if (ExitCode == 0)
                {
                    output.Output("Sample generation completed successfully");
                }
                else
                {
                    output.Output("Sample generation completed with warnings");
                }
            }
        ...
        {
            // Create PackageInfo once at the beginning
            var packageInfo = new FileHelper.PackageInfo(packagePath, languageResolver);

            // Resolve language and output directory using PackageInfo defaults
            ...
            var sourceContext = await GetSourceContextAsync(packageInfo.PackagePath, maxBudget: 40000, priorityBudget: 8000);
...
";
            ...
            // Use microagent to generate the samples
            ...
            try
            {
                ...
                else
                {
                    ...
                    // Write each sample to the output directory
                    ...
                    foreach (var sample in samples)
                    {
                        ...
                        // Clean up the filename - remove any path separators and existing extensions
        ...
        private static async Task<string> GetSourceContextAsync(string packagePath, int maxBudget = 40000, int priorityBudget = 8000)
        {
            // Create priority function to prioritize client-like files
            ...
            // Load files using the generic FileHelper method
