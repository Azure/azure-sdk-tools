import {
    ...
    GenerateAndBuildOptions, getGenerateAndBuildOutput,
...
export class GenerateAndBuildTask implements SDKGenerationTaskBase {
    ...
    public async execute() {
        ...
        const specRepoPath = this.context.specRepo.repoPath.includes('specification') ? this.context.specRepo.repoPath : path.join(this.context.specRepo.repoPath, 'specification');
