...
See [docs/overview.md](docs/overview.md) for full architecture. See [docs/legacy.md](docs/legacy.md) for legacy vs modern boundaries. See [docs/release_approval.md](docs/release_approval.md) for API approval and release gating. See [CHANGELOG.md](CHANGELOG.md) for release notes.
