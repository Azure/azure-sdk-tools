...
public class PackToolTests
{
    ...
    public void Setup()
    {
        ...
        _languageServices = [
            ...
            new DotnetLanguageService(_mockProcessHelper.Object, _mockPowerShellHelper.Object, Mock.Of<ICopilotAgentRunner>(), _mockGitHelper.Object, languageLogger, _commonValidationHelpers.Object, _mockPackageInfoHelper.Object, Mock.Of<IFileHelper>(), _mockSpecGenSdkConfigHelper.Object, Mock.Of<IChangelogHelper>(), Mock.Of<ICiYamlHelper>())
        ];
