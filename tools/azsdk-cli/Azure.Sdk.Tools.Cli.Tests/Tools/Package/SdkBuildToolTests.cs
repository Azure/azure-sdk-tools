...
public class SdkBuildToolTests
{
    ...
    public void Setup()
    {
        ...
        var copilotAgentRunnerMock = new Mock<ICopilotAgentRunner>();
        ...
        _languageServices = [
            ...
            new DotnetLanguageService(_mockProcessHelper.Object, _mockPowerShellHelper.Object, Mock.Of<ICopilotAgentRunner>(), _mockGitHelper.Object, languageLogger, _commonValidationHelpers.Object, packageInfoHelper, Mock.Of<IFileHelper>(), _mockSpecGenSdkConfigHelper.Object, Mock.Of<IChangelogHelper>(), Mock.Of<ICiYamlHelper>())
        ];
