...
{
    [TestFixture]
    public class AnalyzerPromptProviderTests
    {
        [Test]
        public void TryGetPrompt_WithNullRuleId_ReturnsFalse()
        {
            ...
            // Act
            bool result = AnalyzerPromptProvider.TryGetPrompt(ruleId!, out string prompt);
        ...
        public void TryGetContext_WithNullParameters_ReturnsFalse()
        {
            ...
            // Act
            bool result = AnalyzerPromptProvider.TryGetContext(ruleId!, errorMessage!, out string context);

            // Assert
            Assert.That(result, Is.False);
            Assert.That(context, Is.EqualTo(string.Empty));
        }
