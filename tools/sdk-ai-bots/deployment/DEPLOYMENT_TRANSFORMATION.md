...
| File                                                                                             | Purpose                                                        |
| ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------- |
| [azure.yaml](../azure.yaml)                                                                      | Top-level azd manifest and layer dependency graph              |
| [infra/layers/](infra/layers/)                                                                   | Layer-specific Bicep entry points and parameter adapters       |
...
[`infra/layers/`](infra/layers/). There is no parallel module tree to keep in
sync.
