...
This document provides a comprehensive list of all MCP (Model Context Protocol) tools and commands supported by the Azure SDK MCP server version 0.6.38.
...
| azsdk_example_devops_service | `azsdk example demo devops` | Demonstrates DevOps service integration |
| azsdk_example_error_handling | `azsdk example demo error` | Demonstrates error handling patterns in tools |
| azsdk_example_github_service | `azsdk example demo github` | Demonstrates GitHub service integration |
| azsdk_example_powershell_execution | `azsdk example demo powershell` | Demonstrates running a powershell script with a parameter |
| azsdk_example_process_execution | `azsdk example demo process` | Demonstrates running an external process (sleep) and capturing output |
...
| azsdk_hello_world |  | Returns your message with success status |
| azsdk_hello_world_fail |  | Returns an error response for testing failure scenarios |
