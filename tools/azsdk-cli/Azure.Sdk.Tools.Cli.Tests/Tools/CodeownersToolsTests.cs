...
namespace Azure.Sdk.Tools.Cli.Tests.Tools
{
    ...
    public class CodeownersToolsTests
    {
        ...
        public async Task Update_LabelMissing_NotInReview_NoPath_Throws()
        {
            ...
            var tool = new CodeownersTools(gh.Object, _mockOutput.Object, _codeownersHelper, _mockCodeownersValidator.Object);
        ...
        public async Task Update_CreateNewEntry_PRSuccess()
        {
            ...
            var tool = new CodeownersTools(gh.Object, _mockOutput.Object, _codeownersHelper, validator.Object);
        ...
        public async Task Validate_CODEOWNERS_Missing_ReturnsError()
        {
            ...
            var tool = new CodeownersTools(gh.Object, output.Object, helper, validator.Object);
