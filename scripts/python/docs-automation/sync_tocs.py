...
def amend_href(toc_dict, repo_location, readme_suffix):
...
def filter_toc(toc_dict, namespaces, repo_location=None, readme_suffix=None):
    ...
    # handle href
    if "href" in toc_dict and repo_location and readme_suffix:
        toc_dict = amend_href(toc_dict, repo_location, readme_suffix)
