...
'''
        ...
        java_examples = process_java_example_content(java_code.splitlines(keepends=True),
                                                     'VirtualMachineScaleSetVMsStartSamples')

        self.assertEqual(2, len(java_examples))

        self.assertEqual('specification/compute/resource-manager/Microsoft.Compute/ComputeRP/stable/2024-03-01/examples-java/virtualMachineScaleSetExamples', java_examples[0].target_dir)
