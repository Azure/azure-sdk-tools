...
namespace APIViewWeb.Managers.Interfaces
{
    public interface IAPIRevisionsManager
    {
        ...
        public Task<APIRevisionListItemModel> GetNewAPIRevisionAsync(APIRevisionType apiRevisionType, string reviewId = null, string packageName = null, string language = null,
        ...
        public Task<bool> AreAPIRevisionsTheSame(APIRevisionListItemModel apiRevision, RenderedCodeFile renderedCodeFile, bool considerPackageVersion = false, string incomingContentHash = null);
