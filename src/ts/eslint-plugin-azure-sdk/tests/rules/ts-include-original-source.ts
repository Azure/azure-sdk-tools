/**
 * @fileoverview Testing the ts-include-original-source rule.
 * @author Arpan Laha
 */

import rule from "../../src/rules/ts-include-original-source";
...
ruleTester.run("ts-include-original-source", rule, {
  valid: [
    {
