...
namespace Azure.Sdk.Tools.Cli.Tools.CheckAllTool
{
    ...
    public class DependencyCheckFixTool : MCPTool
    {
        ...
        [McpServerTool(Name = "fix-dependency-check-validation"), Description("Fix dependency conflicts in SDK projects. Provide absolute path to project root as param.")]
