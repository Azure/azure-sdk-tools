...
from ._test_util import _render_string, _check, _tokenize, MockApiView
...
class TestDefaultValues:
    ...
    def test_simple_optional_default(self):
        ...
        actual = _render_string(_tokenize(node))
        expected = 'def with_simple_optional_defaults(name: Optional[str] = "Bill", *, age: Optional[int] = 21) -> None'
        _check(actual, expected, DefaultValuesClient)
    ...
    def test_falsy_optional_defaults(self):
        ...
        actual = _render_string(_tokenize(node))
        expected = 'def with_falsy_optional_defaults(*, bool: Optional[bool] = False, int: Optional[int] = 0, string: Optional[str] = "") -> None'
        _check(actual, expected, DefaultValuesClient)
    ...
    def test_parsed_docstring_defaults(self):
        ...
        actual = _render_string(_tokenize(node))
        expected = 'def with_parsed_docstring_defaults(name: str = "Bill", age: int = 21, some_class: class = ":py:class:`apistubgen.test.models.FakeObject`") -> None'
        _check(actual, expected, DefaultValuesClient)
