...
## answer
You should NOT specify an Azure-AsyncOperation or Location header in the 200 response for resource creation (PUT) in your Azure REST API spec. According to the Azure ARM RPC and REST API guidelines, the correct behavior for long-running resource creation operations is:
...
- If your implementation violates this, update it to comply with ARM guidelines. Document your spec as above.