...
public class SwaggerApiViewSpec : INavigable, ITokenSerializable
{
    ...
    public CodeFileToken[] TokenSerialize(SerializeContext context)
    {
        ...
        // ret.Add(TokenSerializer.NavigableToken("General", CodeFileTokenKind.FoldableParentToken, context.IteratorPath.CurrentPath()));
        ...
        ret.Add(TokenSerializer.NavigableToken("Paths", CodeFileTokenKind.FoldableParentToken, context.IteratorPath.CurrentPath()));
        ret.Add(TokenSerializer.Colon());
        ret.Add(TokenSerializer.NewLine());
