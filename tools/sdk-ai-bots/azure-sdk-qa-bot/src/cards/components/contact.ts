...
export function createContactCard() {
  ...
  const card = {
    ...
    body: [
      {
        type: 'TextBlock',
        text: '🤖The responses are generated by an AI model. Info may be outdated or incorrect - Please verify if important. 📩Only the initial message in a post will receive an automatic response. 🔁For follow-up questions, please @mention the bot.',
        wrap: true,
      },
    ],
    actions,
