...
internal class VerifySetupToolTests
{
    ...
    public void Setup()
    {
        ...
        languageServices = [
            new PythonLanguageService(mockProcessHelper.Object, mockPythonHelper.Object, _mockNpxHelper.Object, _mockGitHelper.Object, _languageLogger, _commonValidationHelpers.Object, Mock.Of<IFileHelper>(), Mock.Of<ISpecGenSdkConfigHelper>(), _mockMicrohostAgent.Object),
