...
describe("DictionaryExamples tests", () => {
    ...
    it("single input element", async () => {
        ...
        chai_1.assert.equal(dictionaryExamples[0].normalizedSource, "fly");
    ...
    it("multiple input elements", async () => {
        ...
        const dictionaryExamples = response.body;
        chai_1.assert.isTrue(dictionaryExamples.length === 2);
    });
});
//# sourceMappingURL=dictionaryExamplesTest.spec.js.map