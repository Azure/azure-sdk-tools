...
public class LanguageServicePackageInfoTests
{
    ...
    public void Setup()
    {
        ...
        languageServices = [
            new DotnetLanguageService(processHelper, Mock.Of<IPowershellHelper>(), Mock.Of<ICopilotAgentRunner>(), gitHelper.Object, new TestLogger<DotnetLanguageService>(), Mock.Of<ICommonValidationHelpers>(), packageInfoHelper, Mock.Of<IFileHelper>(), Mock.Of<ISpecGenSdkConfigHelper>(), Mock.Of<IChangelogHelper>()),
            new JavaLanguageService(new Mock<IProcessHelper>().Object, gitHelper.Object, new Mock<IMavenHelper>().Object, pythonHelper, new Mock<ICopilotAgentRunner>().Object, new TestLogger<JavaLanguageService>(), Mock.Of<ICommonValidationHelpers>(), packageInfoHelper, Mock.Of<IFileHelper>(), Mock.Of<ISpecGenSdkConfigHelper>(), Mock.Of<IChangelogHelper>()),
            new PythonLanguageService(new Mock<IProcessHelper>().Object, pythonHelper, new Mock<INpxHelper>().Object, Mock.Of<ICopilotAgentRunner>(), gitHelper.Object, new TestLogger<PythonLanguageService>(), Mock.Of<ICommonValidationHelpers>(), packageInfoHelper, Mock.Of<IFileHelper>(), Mock.Of<ISpecGenSdkConfigHelper>(), Mock.Of<IChangelogHelper>()),
            new JavaScriptLanguageService(new Mock<IProcessHelper>().Object, new Mock<INpxHelper>().Object, Mock.Of<ICopilotAgentRunner>(), gitHelper.Object, new TestLogger<JavaScriptLanguageService>(), Mock.Of<ICommonValidationHelpers>(), packageInfoHelper, Mock.Of<IFileHelper>(), Mock.Of<ISpecGenSdkConfigHelper>(), Mock.Of<IChangelogHelper>()),
