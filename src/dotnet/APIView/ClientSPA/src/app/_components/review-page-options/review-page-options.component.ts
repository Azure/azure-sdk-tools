...
export class ReviewPageOptionsComponent implements OnInit, OnChanges {
  ...
  isReviewedByCopilotAgent: boolean = false;
 ...
 */
  ...
  */
  ...
  private updateApprovalStates(isReviewByCopilotRequired: boolean) {
    ...
    this.isReviewedByCopilotAgent = this.activeAPIRevision?.hasAutoGeneratedComments ?? false;
    
    this.isAPIRevisionApprovalDisabled = isReviewByCopilotRequired && !this.isReviewedByCopilotAgent && !this.activeAPIRevisionIsApprovedByCurrentUser;
