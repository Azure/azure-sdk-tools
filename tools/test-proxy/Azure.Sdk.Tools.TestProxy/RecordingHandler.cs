        ...
        public void SetDefaultExtensions(string recordingId = null)
        {
            ...
            else
            {
                ...
                Sanitizers = new List<RecordedTestSanitizer>
                {
                    ...
                    new BodyRegexSanitizer(regex: "(?<=<UserDelegationKey>).*?(?:<Value>)(.*)(?:</Value>)"),
                    new BodyRegexSanitizer(regex: "(?<=<UserDelegationKey>).*?(?:<SignedTid>)(.*)(?:</SignedTid>)"),
                    new BodyRegexSanitizer(regex: "(?<=<UserDelegationKey>).*?(?:<SignedOid>)(.*)(?:</SignedOid>)"),
                    new BodyRegexSanitizer(regex: "(?:Password=)(.*?)(?:;)"),
                    new BodyRegexSanitizer(regex: "(?:User ID=)(.*?)(?:;)"),
                    new BodyRegexSanitizer(regex: "(?:<PrimaryKey>)(.*)(?:</PrimaryKey>)"),
                    new BodyRegexSanitizer(regex: "(?:<SecondaryKey>)(.*)(?:</SecondaryKey>)"),
                    new BodyKeySanitizer("$..accountKey"),
                    ...
                    new GeneralRegexSanitizer(regex: "common/userrealm/(?<realm>[^/\\.]+)"),
                    new GeneralRegexSanitizer(regex: "/identities/(?<realm>[^/?]+)"),
