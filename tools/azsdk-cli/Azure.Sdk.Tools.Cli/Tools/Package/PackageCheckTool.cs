...
namespace Azure.Sdk.Tools.Cli.Tools.Package
{
    ...
    ) : MCPMultiCommandTool
    {
        ...
        private async Task<CLICheckResponse> RunAllChecks(string packagePath, bool fixCheckErrors, CancellationToken ct)
        {
            ...
            var changelogValidationResult = await languageChecks.ValidateChangelogAsync(packagePath, ct, fixCheckErrors);
            ...
            var readmeValidationResult = await languageChecks.ValidateReadmeAsync(packagePath, ct, fixCheckErrors);
            ...
            // Run spelling check
            var spellingCheckResult = await languageChecks.CheckSpellingAsync(packagePath, ct, fixCheckErrors);
        ...
        private async Task<CLICheckResponse> RunChangelogValidation(string packagePath, bool fixCheckErrors = false, CancellationToken ct = default)
        {
            ...
            var result = await languageChecks.ValidateChangelogAsync(packagePath, ct, fixCheckErrors);
        ...
        private async Task<CLICheckResponse> RunReadmeValidation(string packagePath, bool fixCheckErrors = false, CancellationToken ct = default)
        {
            ...
            var result = await languageChecks.ValidateReadmeAsync(packagePath, ct, fixCheckErrors);
        ...
        private async Task<CLICheckResponse> RunSpellingValidation(string packagePath, bool fixCheckErrors = false, CancellationToken ct = default)
        {
            ...
            var result = await languageChecks.CheckSpellingAsync(packagePath, ct, fixCheckErrors);
            return result;
        }
