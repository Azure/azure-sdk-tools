...
async function dataProductsGenerateStorageAccountSasTokenMaximumSetGen() {
    ...
    const result = await client.dataProducts.generateStorageAccountSasToken(resourceGroupName, dataProductName, body);
    console.log(result);
}
/**
 * This sample demonstrates how to Generate sas token for storage account.
...
//# sourceMappingURL=dataProductsGenerateStorageAccountSasTokenSample.js.map