...
@description('OAuth2 scope the frontend requests for calls to the agent server. Format `<server-application-id-uri>/.default`. Read at startup by config.js validation — MUST be non-empty.')
