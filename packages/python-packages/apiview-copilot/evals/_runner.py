...
class EvalRunner:
    ...
    def run(self):
        ...
        processed_results = custom_eval.process_results(all_run_results, rule_ids)
        custom_eval.show_results(processed_results)
        custom_eval.post_process(processed_results, self.language, str(self._tests_directory), self._test_file, rule_ids)
