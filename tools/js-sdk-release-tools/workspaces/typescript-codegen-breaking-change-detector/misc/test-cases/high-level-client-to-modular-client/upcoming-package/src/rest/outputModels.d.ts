...
export interface UserAssignedIdentitiesOutput extends Record<string, UserAssignedIdentityOutput> {
}
...
export type ManagedServiceIdentityTypeOutput = "None" | "SystemAssigned" | "UserAssigned" | "SystemAssigned, UserAssigned" | string;
...
export type DataProductsCatalogListResultOutput = Paged<DataProductsCatalogOutput>;
