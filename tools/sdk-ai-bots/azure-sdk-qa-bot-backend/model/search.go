...
func GetIndexLink(chunk Index) string {
	...
	case Source_AzureSDKQAKnowledge:
		// Handle documents from curated Q&A knowledge base
		return "https://github.com/Azure/azure-sdk-tools/blob/main/tools/sdk-ai-bots/azure-sdk-qa-bot-knowledge-sync/knowledge/" + path
