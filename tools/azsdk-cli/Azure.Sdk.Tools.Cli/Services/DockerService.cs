...
namespace Azure.Sdk.Tools.Cli.Services
{
    ...
    public interface IDockerService
    {
        ...
        /// <param name="volumeMounts">Optional volume mounts (hostPath -> containerPath).</param>
        /// <param name="ct">Cancellation token.</param>
        /// <returns>Process result containing the container creation output.</returns>
        Task<ProcessResult> CreateContainerAsync(string image, string? containerName = null, IDictionary<string, string>? environmentVars = null, string? workingDirectory = null, IDictionary<string, string>? volumeMounts = null, CancellationToken ct = default);
    ...
    public class DockerService : IDockerService
    {
        ...
        public async Task<ProcessResult> CreateContainerAsync(string image, string? containerName = null, IDictionary<string, string>? environmentVars = null, string? workingDirectory = null, IDictionary<string, string>? volumeMounts = null, CancellationToken ct = default)
        {
            if (string.IsNullOrWhiteSpace(image))
            {
                throw new ArgumentException("Image name cannot be null or empty", nameof(image));
            ...
            if (volumeMounts != null)
            {
                ...
                {
                    args.AddRange(["-v", $"{kvp.Key}:{kvp.Value}"]);
                }
            }
