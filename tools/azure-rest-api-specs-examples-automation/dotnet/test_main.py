...
from main import break_down_aggregated_dotnet_example, find_dotnet_examples_paths, format_dotnet, get_dotnet_using_statements
...
class TestDotNetExamplesPathDiscovery(unittest.TestCase):
    ...
    def test_when_there_is_only_one_sample_directory(self, mock_isdir, mock_listdir, mock_exists):
        ...
        def mock_exists_side_effect(path_arg):
            ...
            if normPath == os.path.normpath("/path/to/sdk/sdk/testservice/Azure.ResourceManager.TestService/tests/Generated/Samples"):
                return True
            if normPath == os.path.normpath("/path/to/sdk/sdk/testservice/Azure.ResourceManager.TestService/tests/Scenarios"):
                return True
            return False
        ...
        self.assertEqual(os.path.normpath(dotnet_examples_paths[0]), os.path.normpath("/path/to/sdk/sdk/testservice/Azure.ResourceManager.TestService/tests/Generated/Samples"))
    ...
    def test_when_there_are_multiple_sample_directories(self, mock_isdir, mock_listdir, mock_exists):
        ...
        def mock_exists_side_effect(path_arg):
            ...
            if normPath == os.path.normpath("/path/to/sdk/sdk/testservice/Azure.ResourceManager.TestService/tests/Generated/Samples"):
                ...
                return True
            elif normPath == os.path.normpath("/path/to/sdk/sdk/testservice/Azure.ResourceManager.TestService/tests/MySql/Generated/Samples"):
                return True # we have two secondary sample directories
            elif normPath == os.path.normpath("/path/to/sdk/sdk/testservice/Azure.ResourceManager.TestService/tests/MySqlFlexibleServer/Generated/Samples"):
                return True # we have two secondary sample directories
            elif normPath == os.path.normpath("/path/to/sdk/sdk/testservice/Azure.ResourceManager.TestService/tests/Scenarios"):
                return True
            return False
        mock_exists.side_effect = mock_exists_side_effect
        ...
        self.assertEqual(os.path.normpath(dotnet_examples_paths[0]), os.path.normpath("/path/to/sdk/sdk/testservice/Azure.ResourceManager.TestService/tests/MySql/Generated/Samples"))
        self.assertEqual(os.path.normpath(dotnet_examples_paths[1]), os.path.normpath("/path/to/sdk/sdk/testservice/Azure.ResourceManager.TestService/tests/MySqlFlexibleServer/Generated/Samples"))
