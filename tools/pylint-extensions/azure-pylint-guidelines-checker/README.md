...
docstring-type-do-not-use-class | pylint:disable=docstring-type-do-not-use-class   |      Docstring type is formatted incorrectly. Please follow Sphinx formatting.               | [link](https://sphinx-rtd-tutorial.readthedocs.io/en/latest/docstrings.html)           |
