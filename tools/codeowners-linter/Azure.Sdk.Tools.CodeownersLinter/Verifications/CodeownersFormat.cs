...
{
    public static class CodeownersFormat
    {
        /// <summary>
        /// Load the Codeowners file and process it a block at a time
        /// </summary>
        /// <param name="directoryUtils"></param>
                                       ...
                                       List<string> codeownersFile)
        {
            ...
            bool endsWithSourceOwnerLine = IsSourcePathOwnerLine(codeownersFile[endBlockLineNumber]);
            ...
            for (int blockLine = startBlockLineNumber; blockLine <= endBlockLineNumber; blockLine++)
            {
                ...
                bool isSourcePathOwnerLine = IsSourcePathOwnerLine(line);
        ...
        {
            return !line.StartsWith(SeparatorConstants.Comment) &&
