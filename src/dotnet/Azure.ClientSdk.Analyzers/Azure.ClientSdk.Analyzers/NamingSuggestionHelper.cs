...
namespace Azure.ClientSdk.Analyzers
{
    ...
    /// </summary>
    internal static class NamingSuggestionHelper
    {
        /// <summary>
        ...
        /// <returns>Formatted suggestion string</returns>
        private static string GetSimpleNamespacedSuggestion(string namespacePrefix, string primaryName, string secondaryName)
        {
        ...
        private static bool IsCompositeClientName(string typeName)
        {
