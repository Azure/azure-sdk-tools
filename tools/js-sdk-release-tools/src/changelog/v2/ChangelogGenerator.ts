...
export class ChangelogGenerator {
  ...
  public generate(): ChangelogResult {
    ...
    // Constructor parameter order changes (same-type params reordered — invisible to TypeScript's structural type system)
    this.detectResult.constructorOrderChangedClasses.forEach((className) => {
